...
Instance of class
Memory allocated
Can access variables and methods
""")

# ------------------------------------------------------------

print("="*60)
print("13. FOUR PILLARS OF OOP")
print("="*60)
...
Q4. Difference between Class Variable and Instance Variable?
...
Q6. What is __init__()?
A. Constructor automatically called when object is created.
...
Static Method
-------------
Utility method; doesn't use object or class state.
""")
